...
import { withSessionsSendRestrictionContext } from "../agents/tools/sessions-send-restriction-context.js";
import type {
...
export function resolveGatewayScopedTools(params: {
  ...
  const openClawTools = withSessionsSendRestrictionContext(
    { callerSessionKey: params.sessionsSendCallerSessionKey },
    () =>
      createOpenClawTools({
